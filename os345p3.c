...
int P3_project3(int argc, char* argv[])
	...
	needDriverMutex = createSemaphore("needDriverMutex", BINARY, 0);		SWAP;
...
int jurassic_driver(int argc, char* argv[]) {
	...
	while(1) {
		...
		if( iSEM_TRYLOCK(needDriverMutex) ) {
